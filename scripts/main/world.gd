...
func add_city(name,position,faction,population,facilities,traits,price_mods):
	...
	Journal.add_entry(city.name, city.name, "cities", city.description, BACKGROUND_IMAGES[city.landscape].file, int(time-60.0*60.0*24.0*365.0*(10.0+population/8000.0)*rand_range(0.9,1.1)))
